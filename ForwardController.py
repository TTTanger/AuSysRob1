...
class BraccioRobot:
    ...
    def __init__(self, com_port='COM5', baud_rate=115200, timeout=5):
        # 定义DH变换矩阵中使用的符号变量
...
if __name__ == "__main__":
    ...
    robot = BraccioRobot(com_port='COM5', baud_rate=115200, timeout=5)

    # 将机器人移动到起始位置
    robot.move_to_home()

    # 命令移动到特定位置
    robot.move_to_angles(0, 90, 180, 90, 0) # 原始 TestBraccioForward 测试的参数
